(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-window ag anzu apheleia beancount bnf-mode browse-kill-ring
                ...
                company-auctex consult crux deadgrep diff-hl diminish
                discover-my-major easy-kill elisp-slime-nav envrc epl
                exec-path-from-shell expand-region flycheck-ledger
                geiser gist git-modes git-timemachine guru-mode
                hl-todo imenu-anywhere ledger-mode lsp-ui lua-mode
                magit move-text nlinum operate-on-number orderless
                projectile racket-mode rainbow-delimiters rainbow-mode
                rust-mode smartparens smartrep super-save undo-tree
                vertico volatile-highlights web-mode yaml-mode
