(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-window ag anzu beancount beancount-mode bnf-mode
                browse-kill-ring clipetty clojure-mode
                color-theme-sanityinc-tomorrow company consult crux
                csv-mode deadgrep diff-hl diminish discover-my-major
                easy-kill editorconfig elisp-slime-nav emacsql-sqlite
                envrc epl exec-path-from-shell expand-region flycheck
                flycheck-ledger gist git-modes git-timemachine
                guru-mode hl-todo imenu-anywhere js2-mode json-mode
                ledger-mode lsp-mode lsp-ui magit move-text nlinum
                operate-on-number orderless projectile protobuf-mode
                racket-mode racket-xp racket-xp-mode
